...
body:                                             ; preds = %entry
  ...
  %add = add i128 %read.a.input1, %read.b.input2
  %sge = icmp sge i128 %add, 4294967296
  ...
  %sub = sub i128 %read.tmp.inter3, 1
  %mul = mul i128 %read.tmp.inter, %sub
  call void @fn_intrinsic_utils_constraint(i128 %mul, i128 0, i1* @constraint)
  %read.a.input4 = load i128, i128* %initial.a.input, align 4
  %read.b.input5 = load i128, i128* %initial.b.input, align 4
  %add6 = add i128 %read.a.input4, %read.b.input5
  %read.tmp.inter7 = load i128, i128* %initial.tmp.inter, align 4
  %mul8 = mul i128 %read.tmp.inter7, 4294967296
  %sub9 = sub i128 %add6, %mul8
  %read.out.output = load i128, i128* %initial.out.output, align 4
  call void @fn_intrinsic_utils_constraint(i128 %read.out.output, i128 %sub9, i1* @constraint.1)
  store i128 %sub9, i128* %initial.out.output, align 4
  br label %exit

exit:                                             ; preds = %body
  %read.tmp.inter10 = load i128, i128* %initial.tmp.inter, align 4
  %"gep.Add32Bits|tmp.inter" = getelementptr inbounds %struct_template_Add32Bits, %struct_template_Add32Bits* %0, i32 0, i32 2
  store i128 %read.tmp.inter10, i128* %"gep.Add32Bits|tmp.inter", align 4
  %read.out.output11 = load i128, i128* %initial.out.output, align 4
  %"gep.Add32Bits|out.output" = getelementptr inbounds %struct_template_Add32Bits, %struct_template_Add32Bits* %0, i32 0, i32 3
  store i128 %read.out.output11, i128* %"gep.Add32Bits|out.output", align 4
  ret void
}
